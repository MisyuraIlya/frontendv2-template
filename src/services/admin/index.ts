...
import { AdminClinetsService } from './AdminClients.service'
import { MediaObjectService } from './AdminMediaObject.service'
...
import { AdminBonusesService } from './AdminBonuses.service'
import { AdminAttributesService } from './AdminAttributes.service'

export default {
  AdminCatalogService: AdminCatalogService,
  AdminClinetsService: AdminClinetsService,
  ...
  AdminBonusesService: AdminBonusesService,
  AdminAttributesService: AdminAttributesService,
}
