...
const List = () => {
  ...
  const [attributes, setAttributes] = useState<IAttributeMain[]>([])
  ...
  const onDragEnd = async (result: DropResult) => {
    ...
    await AdminAttributesService.dragAndDropAttributes(updatedAttributes)
  }
            ...
            <TableContainer component={Paper}>
              ...
              <Table>
                <TableHead>
                  ...
                  <TableCell>נמצא בכרטיס פריט</TableCell>
                  <TableCell>נמצא בפילטרים</TableCell>
